...
class ventanaPerfilCreador(QWidget):
    ...
    def __init__(self):
        ...
        ruta_ui = os.path.join(BASE_DIR, "Vistas", "Ventanas", "perfil_creador_widget.ui")
    ...
    def actualizar_interfaz(self):
        ...
        self.labelVentas.setText(textos.get("labelVentasPerfil")+str(self.usuario_actual.Ventas))
